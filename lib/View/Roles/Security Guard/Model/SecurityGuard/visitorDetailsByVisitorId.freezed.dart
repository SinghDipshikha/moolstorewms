...
GetVisitorDetailsByVisitor _$GetVisitorDetailsByVisitorFromJson(
    Map<String, dynamic> json) {
  return _GetVisitorDetailsByVisitor.fromJson(json);
}

/// @nodoc
mixin _$GetVisitorDetailsByVisitor {
  ...
  @JsonKey(ignore: true)
  $GetVisitorDetailsByVisitorCopyWith<GetVisitorDetailsByVisitor>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GetVisitorDetailsByVisitorCopyWith<$Res> {
  factory $GetVisitorDetailsByVisitorCopyWith(GetVisitorDetailsByVisitor value,
          $Res Function(GetVisitorDetailsByVisitor) then) =
      _$GetVisitorDetailsByVisitorCopyWithImpl<$Res,
          GetVisitorDetailsByVisitor>;
  @useResult
  $Res call(
      {int? id,
...
/// @nodoc
class _$GetVisitorDetailsByVisitorCopyWithImpl<$Res,
        $Val extends GetVisitorDetailsByVisitor>
    implements $GetVisitorDetailsByVisitorCopyWith<$Res> {
  _$GetVisitorDetailsByVisitorCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$GetVisitorDetailsByVisitorImplCopyWith<$Res>
    implements $GetVisitorDetailsByVisitorCopyWith<$Res> {
  factory _$$GetVisitorDetailsByVisitorImplCopyWith(
          _$GetVisitorDetailsByVisitorImpl value,
          $Res Function(_$GetVisitorDetailsByVisitorImpl) then) =
      __$$GetVisitorDetailsByVisitorImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? id,
...
/// @nodoc
class __$$GetVisitorDetailsByVisitorImplCopyWithImpl<$Res>
    extends _$GetVisitorDetailsByVisitorCopyWithImpl<$Res,
        _$GetVisitorDetailsByVisitorImpl>
    implements _$$GetVisitorDetailsByVisitorImplCopyWith<$Res> {
  __$$GetVisitorDetailsByVisitorImplCopyWithImpl(
      _$GetVisitorDetailsByVisitorImpl _value,
      $Res Function(_$GetVisitorDetailsByVisitorImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GetVisitorDetailsByVisitorImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$GetVisitorDetailsByVisitorImpl implements _GetVisitorDetailsByVisitor {
  const _$GetVisitorDetailsByVisitorImpl(
      {this.id,
  ...
  factory _$GetVisitorDetailsByVisitorImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$GetVisitorDetailsByVisitorImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GetVisitorDetailsByVisitorImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GetVisitorDetailsByVisitorImplCopyWith<_$GetVisitorDetailsByVisitorImpl>
      get copyWith => __$$GetVisitorDetailsByVisitorImplCopyWithImpl<
          _$GetVisitorDetailsByVisitorImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GetVisitorDetailsByVisitorImplToJson(
      this,
    );
  }
}

abstract class _GetVisitorDetailsByVisitor
    implements GetVisitorDetailsByVisitor {
  const factory _GetVisitorDetailsByVisitor(
      {final int? id,
      final int? ticket_generate_by,
      final dynamic ticket_verify_by,
      final String? visit_ticket_number,
      ...
      final dynamic remarks,
      final DateTime? created_at,
      final dynamic updated_at}) = _$GetVisitorDetailsByVisitorImpl;

  factory _GetVisitorDetailsByVisitor.fromJson(Map<String, dynamic> json) =
      _$GetVisitorDetailsByVisitorImpl.fromJson;
