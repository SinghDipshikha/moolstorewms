...
class TextStyles {
  static TextStyle talbleHeadingTitleStyle = TextStyle(
    color: AppColors.primaryColor,
    fontSize: 10,
    fontFamily: 'SF Pro Display',
    fontWeight: FontWeight.w400,
  );
  static TextStyle talbleContentTextStyle = const TextStyle(
...
class AppColors {
  ...
  static Color linkedInBGColor = const Color.fromARGB(255, 202, 204, 206);
