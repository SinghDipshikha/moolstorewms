...
GetAllVisitorBySecurityGaurd _$GetAllVisitorBySecurityGaurdFromJson(
    Map<String, dynamic> json) {
  return _GetAllVisitorBySecurityGaurd.fromJson(json);
}

/// @nodoc
mixin _$GetAllVisitorBySecurityGaurd {
  ...
  @JsonKey(ignore: true)
  $GetAllVisitorBySecurityGaurdCopyWith<GetAllVisitorBySecurityGaurd>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GetAllVisitorBySecurityGaurdCopyWith<$Res> {
  factory $GetAllVisitorBySecurityGaurdCopyWith(
          GetAllVisitorBySecurityGaurd value,
          $Res Function(GetAllVisitorBySecurityGaurd) then) =
      _$GetAllVisitorBySecurityGaurdCopyWithImpl<$Res,
          GetAllVisitorBySecurityGaurd>;
  @useResult
  $Res call(
      {int? id,
...
/// @nodoc
class _$GetAllVisitorBySecurityGaurdCopyWithImpl<$Res,
        $Val extends GetAllVisitorBySecurityGaurd>
    implements $GetAllVisitorBySecurityGaurdCopyWith<$Res> {
  _$GetAllVisitorBySecurityGaurdCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$GetAllVisitorBySecurityGaurdImplCopyWith<$Res>
    implements $GetAllVisitorBySecurityGaurdCopyWith<$Res> {
  factory _$$GetAllVisitorBySecurityGaurdImplCopyWith(
          _$GetAllVisitorBySecurityGaurdImpl value,
          $Res Function(_$GetAllVisitorBySecurityGaurdImpl) then) =
      __$$GetAllVisitorBySecurityGaurdImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? id,
...
/// @nodoc
class __$$GetAllVisitorBySecurityGaurdImplCopyWithImpl<$Res>
    extends _$GetAllVisitorBySecurityGaurdCopyWithImpl<$Res,
        _$GetAllVisitorBySecurityGaurdImpl>
    implements _$$GetAllVisitorBySecurityGaurdImplCopyWith<$Res> {
  __$$GetAllVisitorBySecurityGaurdImplCopyWithImpl(
      _$GetAllVisitorBySecurityGaurdImpl _value,
      $Res Function(_$GetAllVisitorBySecurityGaurdImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$GetAllVisitorBySecurityGaurdImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$GetAllVisitorBySecurityGaurdImpl
    implements _GetAllVisitorBySecurityGaurd {
  const _$GetAllVisitorBySecurityGaurdImpl(
      {this.id,
  ...
  factory _$GetAllVisitorBySecurityGaurdImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$GetAllVisitorBySecurityGaurdImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$GetAllVisitorBySecurityGaurdImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$GetAllVisitorBySecurityGaurdImplCopyWith<
          _$GetAllVisitorBySecurityGaurdImpl>
      get copyWith => __$$GetAllVisitorBySecurityGaurdImplCopyWithImpl<
          _$GetAllVisitorBySecurityGaurdImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$GetAllVisitorBySecurityGaurdImplToJson(
      this,
    );
  }
}

abstract class _GetAllVisitorBySecurityGaurd
    implements GetAllVisitorBySecurityGaurd {
  const factory _GetAllVisitorBySecurityGaurd(
      {final int? id,
      final int? ticket_generate_by,
      final String? ticket_verify_by,
      final String? visit_ticket_number,
      ...
      final dynamic status,
      final DateTime? created_at,
      final dynamic updated_at}) = _$GetAllVisitorBySecurityGaurdImpl;

  factory _GetAllVisitorBySecurityGaurd.fromJson(Map<String, dynamic> json) =
      _$GetAllVisitorBySecurityGaurdImpl.fromJson;
