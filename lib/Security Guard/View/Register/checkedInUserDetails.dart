...
class CheckedInUserDetails extends StatefulWidget {
  ...
  @override
  State<CheckedInUserDetails> createState() => _CheckedInUserDetailsState();
}

class _CheckedInUserDetailsState extends State<CheckedInUserDetails> {
  @override
            ...
            child: Container(
              ...
              decoration: ShapeDecoration(
                gradient: const LinearGradient(
                  ...
                  colors: [Color(0xFF027C7A), Color(0xFF008F8C)],
                ),
                shape: RoundedRectangleBorder(
