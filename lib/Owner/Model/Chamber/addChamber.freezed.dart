...
ChamberField _$ChamberFieldFromJson(Map<String, dynamic> json) {
  return _ChamberField.fromJson(json);
}

/// @nodoc
mixin _$ChamberField {
  ...
  @JsonKey(ignore: true)
  $ChamberFieldCopyWith<ChamberField> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ChamberFieldCopyWith<$Res> {
  factory $ChamberFieldCopyWith(
          ChamberField value, $Res Function(ChamberField) then) =
      _$ChamberFieldCopyWithImpl<$Res, ChamberField>;
  @useResult
  $Res call(
      {int id,
      String field_name,
...
/// @nodoc
class _$ChamberFieldCopyWithImpl<$Res, $Val extends ChamberField>
    implements $ChamberFieldCopyWith<$Res> {
  _$ChamberFieldCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ChamberFieldImplCopyWith<$Res>
    implements $ChamberFieldCopyWith<$Res> {
  factory _$$ChamberFieldImplCopyWith(
          _$ChamberFieldImpl value, $Res Function(_$ChamberFieldImpl) then) =
      __$$ChamberFieldImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class __$$ChamberFieldImplCopyWithImpl<$Res>
    extends _$ChamberFieldCopyWithImpl<$Res, _$ChamberFieldImpl>
    implements _$$ChamberFieldImplCopyWith<$Res> {
  __$$ChamberFieldImplCopyWithImpl(
      _$ChamberFieldImpl _value, $Res Function(_$ChamberFieldImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ChamberFieldImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$ChamberFieldImpl implements _ChamberField {
  const _$ChamberFieldImpl(
      {required this.id,
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ChamberFieldImplCopyWith<_$ChamberFieldImpl> get copyWith =>
      __$$ChamberFieldImplCopyWithImpl<_$ChamberFieldImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ChamberFieldImplToJson(
      this,
    );
  }
}

abstract class _ChamberField implements ChamberField {
  const factory _ChamberField(
  ...
  factory _ChamberField.fromJson(Map<String, dynamic> json) =
      _$ChamberFieldImpl.fromJson;
...
AddChamber _$AddChamberFromJson(Map<String, dynamic> json) {
  return _AddChamber.fromJson(json);
}
...
mixin _$AddChamber {
  ...
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $AddChamberCopyWith<AddChamber> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $AddChamberCopyWith<$Res> {
  factory $AddChamberCopyWith(
          AddChamber value, $Res Function(AddChamber) then) =
...
/// @nodoc
class _$AddChamberCopyWithImpl<$Res, $Val extends AddChamber>
    implements $AddChamberCopyWith<$Res> {
  _$AddChamberCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$AddChamberImplCopyWith<$Res>
    implements $AddChamberCopyWith<$Res> {
  factory _$$AddChamberImplCopyWith(
          _$AddChamberImpl value, $Res Function(_$AddChamberImpl) then) =
      __$$AddChamberImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? user_id,
...
/// @nodoc
class __$$AddChamberImplCopyWithImpl<$Res>
    extends _$AddChamberCopyWithImpl<$Res, _$AddChamberImpl>
    implements _$$AddChamberImplCopyWith<$Res> {
  __$$AddChamberImplCopyWithImpl(
      _$AddChamberImpl _value, $Res Function(_$AddChamberImpl) _then)
      : super(_value, _then);
...
class _$AddChamberImpl implements _AddChamber {
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$AddChamberImplCopyWith<_$AddChamberImpl> get copyWith =>
      __$$AddChamberImplCopyWithImpl<_$AddChamberImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$AddChamberImplToJson(
      this,
    );
  }
}
